                                ...
                                <div className="out">
                                    ...
                                    <div className="card" id="num">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <button type="submit" class="btn btn-success btn-lg mt-3" style={{ background: "#26CDD1", width: "100px" }} onClick={() => navigate("/updateProfile/" + id)} >Update</button>
                                            <button type="button" class="btn btn-secondry btn-lg mt-3" style={{ background: "#afafaf", width: "100px" }} onClick={() => navigate("/deleteProfile/" + id)}>Delete</button>
